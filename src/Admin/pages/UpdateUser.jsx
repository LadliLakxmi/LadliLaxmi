...
const UpdateUser = () => {
  ...
  const handleFetchUserByEmail = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        accountNumber: '', accountHolder: '', bankName: '', ifscCode: '', upiId: '',
  ...
  // Show admin password modal on Update click
  ...
  // Handle update with admin password verification
  const handleUpdateUser = async (e) => {
    ...
    const updatePayload = {
      ...
      adminPassword: adminPasswordInput, // Admin password for verification
    };
    if (formData.password) {
      updatePayload.password = formData.password;
    }
    if (!userIdToUpdate) {
      setError('Please fetch a user before update.');
    ...
    try {
      ...
      setAdminPasswordError(
        err.response?.data?.message || 'Update failed. Possible incorrect password.'
      );
    } finally {
      setIsUpdating(false);
    }
